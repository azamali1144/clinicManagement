...
@section('content')
    <main role="main" class="col-md-11 ml-sm-auto col-lg-11 pt-3 px-4">
        ...
        <form method="post" action="{{ route('expanse.update', ['id' => $expanse->id]) }}" data-parsley-validate class="form-horizontal form-label-left">

            <div class="form-group{{ $errors->has('details') ? ' has-error' : '' }} row">
                <label for="name" class="col-sm-2 col-form-label">Details</label>
                <div class="col-sm-10">
                    <input type="text" value="{{$expanse->details}}" id="details" name="details" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }} row">
                ...
                <div class="col-sm-10">
                    <input type="number" value="{{$expanse->amount}}" id="amount" name="amount" class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }} row">
                <label class="col-sm-2 col-form-label" for="category_id">Date & Time</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" value="{{$expanse->date}}" id="date" name="date" class="form-control col-md-7 col-xs-12">
                    @if ($errors->has('date'))
